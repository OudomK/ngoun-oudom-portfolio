...
import KiloIT from '../image/kiloit.png';
...
const Certificates = () => {
  ...
  // Education & Training (more extensive programs)
  const educationTraining = [
    {
      title: 'KiloIT',
      logo: KiloIT,
      issuer: 'KiloIT Training Center',
      description: 'Frontend Development Training (6 Months) – React.js, JavaScript, Business Analysis, SDLC.',
    ...
    {
      title: 'Above & Beyond (A&B)',
      logo: Anb,
      issuer: 'Above & Beyond School',
      description: 'Backend Engineering Bootcamp (3 Months) – Node.js, Express.js, FastAPI, SQL, Agile/Scrum.',
    ...
    <section id="certificates" className="py-20 bg-gradient-to-b from-gray-800 to-gray-900 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-gray-400 mt-4 text-lg">Comprehensive programs and trainings I've completed</p>
        </div>
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
          {educationTraining.map((course, index) => (
            <div
              key={index}
            ...
            >
              <div className={`w-14 h-14 bg-gradient-to-br ${course.color} rounded-xl flex items-center justify-center mb-5 group-hover:scale-110 transition-transform duration-300 shadow-lg overflow-hidden`}
                ...
                {course.logo ? (
                  ...
                  <span className="text-white font-bold text-xs leading-none text-center px-1">E&amp;T</span>
                )}
              </div>
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-gray-400 mt-4 text-lg">Learning courses and programs I have completed</p>
        </div>
